...
Runs, in order:
    ...
    5. sync_data.py                — mirror wnba_rapm CSVs to data/
...
def main():
    ...
    if not args.skip_fetch:
        print("\n=== Step 1: Update stints (wnba_rapm) ===")
        run([py, "update_stints.py", "--season", year], cwd=RAPM_ROOT, check=False)
    ...
    print("\n=== Step 5: Sync wnba_rapm CSVs into data/ ===")
